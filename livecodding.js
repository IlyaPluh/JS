...
// 5. отформатировать номер телефона по заданной маске. На вход подается номер (число) и стринга (темплейт). Если чисел в номере больше чем надо в маске - игнорируем оставшиеся ненужные, если чисел меньше чем надо в маске - кидаем ошибку
